...
int main (int argc, char **argv) {
    ...
    set_config(conf, "sasl.oauthbearer.client.id",          "<OAUTH2 CLIENT ID>");
    set_config(conf, "sasl.oauthbearer.client.secret",      "<OAUTH2 CLIENT SECRET>");
    set_config(conf, "sasl.oauthbearer.token.endpoint.url", "<OAUTH2 TOKEN ENDPOINT URL>");
    set_config(conf, "sasl.oauthbearer.scope",              "<OAUTH2 SCOPE>");
