...
{
  CORO_BEGIN(ctx);
  // std::cout<<"create_bearer_context_setup_result Started"<<std::endl;
  ...
  // std::cout<<"create_bearer_context_setup_result Started1"<<std::endl;
  // Send command to CU-UP.
  send_bearer_context_setup_request();
  // std::cout<<"create_bearer_context_setup_result Starte2"<<std::endl;
  // Await response.
  CORO_AWAIT(transaction_sink);
  // std::cout<<"create_bearer_context_setup_result Exited"<<std::endl;
...
void bearer_context_setup_procedure::send_bearer_context_setup_request()
{
  ...
  // std::cout<<"Sending the message to e1ap_notifier "<<std::endl;
