...
void runPeriodic(std::function<void(void)> f, int duration)
{
...
void cell_scheduler::run_slot(slot_point sl_tx)
{
  ...
  // std::cout<<"Cell Scheduler got a new request to schedule new slot"<<std::endl;
  ...
  // std::cout<<"Going for DL-Ul Slot Schdeule\t "<<slotCount<<std::endl;
