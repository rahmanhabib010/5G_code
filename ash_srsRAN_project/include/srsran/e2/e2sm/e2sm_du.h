...
struct ric_control_config_slice {
  std::vector<slice_params> slice_config_list;
};

struct ric_control_config_response_slice {
...
struct ric_control_config {
  ...
  // Following field will be populated only if Slice-Resource-Allocations need to change
  optional<ric_control_config_slice> per_slice_alloc;
};
